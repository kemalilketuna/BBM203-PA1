...
// how to compile
// g++ -std=c++11 -o main main.cpp ImageMatrix.cpp Convolution.cpp DecodeMessage.cpp EncodeMessage.cpp ImageSharpening.cpp EdgeDetector.cpp ImageProcessor.cpp ImageLoader.cpp